...
import 'package:serverpod_auth_core_server/serverpod_auth_core_server.dart'
    as _i4;
import 'package:cogniclaim_server/src/generated/greetings/greeting.dart' as _i5;
import 'package:cogniclaim_server/src/generated/myragchat/aichat.dart' as _i6;
import 'package:cogniclaim_server/src/generated/myragchat/myragchat.dart'
    as _i7;
import 'package:cogniclaim_server/src/generated/protocol.dart';
import 'package:cogniclaim_server/src/generated/endpoints.dart';
...
class TestEndpoints {
  ...
  late final _MyragchatEndpoint myragchat;
}
...
class _AichatEndpoint {
  ...
  _i3.Future<_i6.AiChat> performAiChat(
    _i1.TestSessionBuilder sessionBuilder,
    String message,
    String uniqueId,
    List<int>? imageBytes,
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'aichat',
            method: 'performAiChat',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'aichat',
          methodName: 'performAiChat',
          parameters: _i1.testObjectToJson({
            'message': message,
            'uniqueId': uniqueId,
...
class _MyragchatEndpoint {
  ...
  _i3.Future<_i7.MyRagChat> getMyRagChat(
    _i1.TestSessionBuilder sessionBuilder,
    String message,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'myragchat',
          methodName: 'getMyRagChat',
