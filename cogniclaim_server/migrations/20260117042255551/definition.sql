...
--
-- MIGRATION VERSION FOR cogniclaim
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('cogniclaim', '20260117042255551', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260117042255551', "timestamp" = now();
