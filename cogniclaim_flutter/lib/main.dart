...
import 'package:cogniclaim_flutter/screens/greetings_screen.dart';
import 'package:cogniclaim_flutter/screens/welcome_screen.dart';
...
void main() async {
  ...
  Logger.log("ServerUrl : $serverUrl");
  String finalUrl;
  if(Platform.isAndroid) {
    finalUrl = "http://10.0.2.2:8080/";
